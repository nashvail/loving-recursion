...
The first observation is that, a given pair of exterior and interior angles lie on a single line. Which means the sum of each of  these pairs is equal to 180 degrees.
...
Because we have three sides in a triangle we have three pairs of angles, if we had a square with 4 sides or a pentagon with PENT sides, we'd have 5 pairs of angles each pair adding up to 180 degrees. 
